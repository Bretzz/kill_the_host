...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/27 18:50:04 by ale               #+#    #+#             */
/*   Updated: 2025/02/27 18:53:56 by ale              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cleanup_map_and_textures(t_mlx_data *data)
{
	...
	if (data->player)
		mlx_destroy_image(data->mlx, data->play_u);
	if (data->player)
		mlx_destroy_image(data->mlx, data->play_l);
	if (data->player)
		mlx_destroy_image(data->mlx, data->play_r);
	if (data->wall)
